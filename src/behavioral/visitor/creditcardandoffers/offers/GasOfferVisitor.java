...
public class GasOfferVisitor implements OfferVisitor {
   ...
   /* @Override
    public void visit(BronzeCreditCard bronzeCreditCard) {
        System.out.println(bronzeCreditCard.getName() + " is interacting with GasOfferVisitor");
    }

    @Override
    public void visit(SilverCreditCard silverCreditCard) {
        System.out.println(silverCreditCard.getName() + " is interacting with GasOfferVisitor");
    }

    @Override
    public void visit(GoldCreditCard goldCreditCard) {
        System.out.println(goldCreditCard.getName() + " is interacting with GasOfferVisitor");
    }*/

    @Override
    public void visit(CreditCard creditCard) {
        System.out.println(creditCard.getName() + " is interacting with GasOfferVisitor");
    }
}
